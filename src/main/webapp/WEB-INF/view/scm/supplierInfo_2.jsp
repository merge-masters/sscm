...
<script type="text/javascript">
	...
	var pageBlockSizeSupplier = 5;		// 공급처정보 페이지 블록 개수
	
	// 제품정보 페이징 처리
	var pageSizeProduct = 5;				// 제품정보 페이지 사이즈
	var pageBlockSizeProduct = 5;		// 제품정보 페이지 블록 개수
	
	// controller에서 정보를 Model에 담지 말고 Map에 담음
	
	// Onload 이벤트
	$(document).ready(function() {
		
		init();												//전역 컴포넌트 정의 (Vue 앱 내에서 어디에서나 사용 가능하도록)
		
		var listSupplierVue;							// 납품회사 목록 조회(납품업체명, 로그인 아이디, 비밀번호, 담당자명, 담당자 연락처) 함수 - fListSupplier();
		
		
		var fRegisterButtonClickEvent;			// 검색 버튼 이벤트 등록 함수
	...
	function init() {
		...
		// 버튼 이벤트 등록
		function fRegistorButtonClickEvent() {
	...
	// 납품회사 목록 조회 함수
	// fuction fListSupplier(currentPage) {};
	
	// 검색 버튼 이벤트 함수
	// fuction fRegisterButtonClickEvent(data, currentPage) {};
	
	// 공급업체 조회 콜백 함수
	function flistSupplierResult(data) {
        ...
        <h2 class="hidden">header 영역</h2>
          ...
          <ul>
                  ...
                  <li class="contents">
                    ...
                    <div class="SupplierList" id="supplier-list">
